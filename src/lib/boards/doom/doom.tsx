...
const doom = {
  ...
  앱 기획 및 개발자로 참여하여 팀원들과 소통하며 자유롭게 각자의 의견을 내어 좋은 기획을 구상할 수 있었고, Notion과 Slack을 적극적으로 활용하여 다른 팀원들과 좋은 의견들을 주고받으며 프로젝트를 진행하였다. 프로젝트 진행 중 팀원 한 명의 노트북이 불의의 사고를 겪으며 개발에 참여할 수 없게 되었다. 그 팀원이 깃허브를 사용하였다면, 좋았겠지만 그렇지 않아 코드도 복구하지 못하게 되었다. 깃허브의 중요성을 다시 알게 해 주는 기회였다. 백엔드 코드가 날아갔지만, firebase를 배우게 되었고, 프로젝트를 계속 진행하여 기획과 개발 완성도를 인정받아 동상을 수상하게 되었다.
  </p>
  `,
